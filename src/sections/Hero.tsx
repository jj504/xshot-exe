      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span style={{ color: "var(--phosphor-white)" }}>
                <DecodeText
                  text="your ai pipeline breaks at 3am."
                  preset="headline"
                  active={phase >= 2}
                  className="block"
                />
              </span>
              <span style={{ color: "var(--signal-cyan-100)" }}>
                <DecodeText
                  text="not anymore."
                  preset="headline"
                  active={phase >= 2}
            ...
            <div
              style={{
                ...
                flexDirection: "column",
                gap: "4px",
                fontSize: "var(--text-system-lg)",
              }}
            >
              <DecodeText
                text="describe what your ai pipeline should do."
                preset="body"
                active={phase >= 3}
                className="block font-mono"
              />
              <DecodeText
                text="the agent builds it — models, retries, fallbacks, cost limits —"
                preset="body"
                active={phase >= 3}
                delay={700}
                className="block font-mono"
              />
              <DecodeText
                text="and deploys it as a stable api. no infra. no babysitting."
                preset="body"
                active={phase >= 3}
                delay={1400}
            ...
            >
              for developers building with comfyui &middot; fal &middot;
              replicate &middot; jupyter &middot; custom models
            </div>
          </div>
          ...
          <div className="flex-1 lg:max-w-[45%]" style={{ width: "100%" }}>
            <Module
              ...
              statusColor={
                gridLocked ? "var(--signal-cyan-100)" : "var(--signal-cyan-60)"
              }
